...
- Name: functional\chat.journey.spec.ts >> chat journey @functional @chat >> send text and use in-thread search scopes + stepper
- Location: tests\functional\chat.journey.spec.ts:5:7
...
Call log:
  - waiting for getByTestId('chat-composer')

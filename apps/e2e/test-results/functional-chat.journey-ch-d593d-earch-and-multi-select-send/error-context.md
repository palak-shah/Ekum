...
- Name: functional\chat.journey.spec.ts >> chat journey @functional @chat >> attach design picker has search and multi-select send
- Location: tests\functional\chat.journey.spec.ts:32:7
...
Call log:
  - waiting for getByTestId('chat-attach')

...
| Dispatch sheet | **h-12** design thumb (`order-line-photo`) + name + remaining; compact qty; **LR** / transporter / parcels optional in footer. Same thumb pattern on Send quote, Confirm/decline, Settle, Edit, Return, mill Send. |
